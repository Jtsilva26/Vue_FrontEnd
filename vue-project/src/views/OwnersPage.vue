<template>
    <div class="flex h-screen-3xl flex-1 flex-col justify-center px-6 py-12 lg:px-8 bg-gray-900 bg-repeat">
        <main class="relative isolate">
            ...
            <div class="mx-auto mt-20 max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
                        <div class="w-full md:w-1/3 p-8 container flow-root float-left">
                            <CreateOwner />
                        </div>
